...
;(function (factory) {
	...
	var Pagination = function(element,options){
		...
		this.filling = function(index){
			...
			//修改页码input框大小 type="text " 要在text后加空格 才能不进入bootstrap的样式
            html += opts.jump ? '<input type="text " class="inputPagination '+opts.jumpIptCls+'"><a href="javascript:;" class="'+opts.jumpBtnCls+'">'+opts.jumpBtn+'</a>' : '';
